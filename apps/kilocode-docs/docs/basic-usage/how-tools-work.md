...
Harvi Code uses tools to interact with your code and environment. These specialized helpers perform specific actions like reading files, making edits, running commands, or searching your codebase. Tools provide automation for common development tasks without requiring manual execution.

## Tool Workflow

Describe what you want to accomplish in natural language, and Harvi Code will:
...
**Harvi Code:** (Proposes the `write_to_file` tool as shown in the image above)
...
**Harvi Code:** (Confirms file creation)
