...
# Setting up Harvi Code

When you sign up for Harvi Code, you'll receive **free credits** to help you get started. To claim your credits:
...
Harvi Code provides a simple registration process that gives you access to the latest frontier coding models with your Harvi Code login.

1. Click on "Try Harvi Code for Free" in the extension
...
<img
  ...
  alt="Sign up and registration flow with Harvi Code"
/>
