...
# Using GCP Vertex AI With Harvi Code

Harvi Code supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
- **Application Default Credentials (ADC):** Harvi Code uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
Harvi Code supports the following models through Vertex AI (based on source code):
