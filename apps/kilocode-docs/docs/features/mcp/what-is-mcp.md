...
Harvi Code implements the Model Context Protocol to:
...
- [Using MCP in Harvi Code](/features/mcp/using-mcp-in-kilo-code) - Get started with MCP in Harvi Code, including creating simple servers
