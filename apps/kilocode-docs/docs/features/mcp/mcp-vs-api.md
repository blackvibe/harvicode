...
## Why Harvi Code Uses MCP

Harvi Code leverages MCP to provide:
...
MCP creates a universal connector between Harvi Code and external services, with REST APIs often powering those services behind the scenes.
