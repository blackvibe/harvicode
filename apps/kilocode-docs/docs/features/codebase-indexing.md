...
Codebase Indexing enables semantic code search across your entire project using AI embeddings. Instead of searching for exact text matches, it understands the _meaning_ of your queries, helping Harvi Code find relevant code even when you don't know specific function names or file locations.
...
4. **Provides the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool** to Harvi Code for intelligent code discovery
...
- **Enhanced AI Understanding**: Harvi Code can better comprehend and work with your codebase
...
1. Open Harvi Code settings (<Codicon name="gear" /> icon)
...
Once indexed, Harvi Code can use the [`codebase_search`](/advanced-usage/available-tools/codebase-search) tool to find relevant code:
...
The tool provides Harvi Code with:
