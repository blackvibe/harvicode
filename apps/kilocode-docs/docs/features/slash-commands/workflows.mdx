...
Workflows automate repetitive tasks by defining step-by-step instructions for Harvi Code to execute. Invoke any workflow by typing `/[workflow-name.md]` in the chat.

<img src="/docs/img/slash-commands/workflows.png" alt="Workflows tab in Harvi Code" width="600" />
...
Now you can trigger this workflow by typing `/submit-pr.md` in the chat. Harvi Code will:
