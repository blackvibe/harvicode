...
Workflows 通过为 Harvi Code 定义分步指令来自动化重复性任务。通过在聊天中键入 `/[workflow-name.md]` 来调用任何工作流。

<img src="/docs/img/slash-commands/workflows.png" alt="Harvi Code 中的工作流选项卡" width="600" />
...
现在您可以通过在聊天中键入 `/submit-pr.md` 来触发此工作流。Harvi Code 将：
