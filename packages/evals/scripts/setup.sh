...
build_extension() {
  echo "🔨 Building the Harvi Code extension..."
...
echo -n "🗄️ Syncing Harvi Code evals database... "
...
read -p "💻 Do you want to build a new version of the Harvi Code extension? [currently $current_version] (y/N): " build_extension
