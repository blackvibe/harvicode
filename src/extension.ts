...
export async function activate(context: vscode.ExtensionContext) {
	...
	if (!context.globalState.get("firstInstallCompleted")) {
		outputChannel.appendLine("First installation detected, opening Harvi Code sidebar!")
		try {
			await vscode.commands.executeCommand("kilo-code.SidebarProvider.focus")

			outputChannel.appendLine("Opening Harvi Code walkthrough")
	...
	// kilocode_change start - Harvi Code specific registrations
	...
	// kilocode_change end - Harvi Code specific registrations

	registerCodeActions(context)
	registerTerminalActions(context)

	// Allows other extensions to activate once Harvi Code is ready.
